...
public class DeepslateUraniumOre extends Block {
    ...
    private static final double RADIUS = 2.0; // Effect radius in blocks
    ...
    public DeepslateUraniumOre(Properties properties) {
    ...
    private int calculatePoisonLevel(double distanceSqr) {
        ...
        if (distanceSqr < 4) {             // Within 20 blocks (20^2 = 400)
            return 1;
        }
        return 0;
    }
